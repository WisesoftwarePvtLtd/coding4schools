...
<link href="https://www.codingfirst.org/css/style.css?1764663426" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764663426" rel="stylesheet" media="all">
...
<nav class="menu menu-desktop">
    <div class="menu-sizer">
        ...
        <ul class="links">
            ...
            <li class="dropdown"><a id="course_dropdpwn" class="scroll_to" href="javascript:;">Courses
...
<script language="javascript">
    function HeaderFunctions(){
        $(document).ready(function(){
            ...
            $('.myeditorbtn').click(function(){
                $('.editor_dropdown_list').toggleClass('show_dd_menu');
            });
        ...
        $('#hide_menu').click(function(event){
            event.stopPropagation();
            $('.side-menu2, .side-menu3').toggleClass('hidden_menu')
            $('.hide_menu').toggleClass('hidden_icon')
...
<div class="page-body-inner">
    ...
    <div class="grid-pattern-7">
        <div class="left">
            <div class="package-section-title-2">
                Choose a Plan and number of students
            </div>
            <div class="notification-message blue-bg text-left p-relative">
                <span class="close-btn">&times;</span>
                <b>Enjoy discounts on non-discounted courses when purchasing multiple courses in a single transaction: 10% off for 2 courses, 15% off for 3 courses, and 20% off for 4 or more courses.</b>

            </div>

            <form method="post">
            <div class="course-package flex-space-between">

                                    <div class="course-item w-400px">
                                                <div class="circle"></div>
                        <div class="course-detail">
                            <img src="https://www.codingfirst.org/data/course_package/9.png" alt="">
                ...
                <div class="white-box-shadow w-50 m-b-30p">
                    <div class="order-detail">
                        <div class="order-detail-info">
                            <div class="title">
                                <span id="student_number">10</span> Students
                            </div>
                            <div class="text">Valid for 365 days</div>

                        </div>


                        <table class="order_detail_price">


                            <tr>
                                <td>Package Price</td>
                                <td>1 x <span id="plan_price">20.00</span></td>
                                <td><span id="plan_price_total">20.00</span></td>
                            </tr>

                            <tr>
                                <td>Students</td>
                                <td><span id="student_number2"> 10 </span> x 2.00</td>
                                <td><span id="student_total_price">20.00</span></td>
                            </tr>
                            
                                                          <tr class="subtotal">
                                   <td>Subtotal</td>
                                   <td></td>
                                   <td><span id="subtotal">40.00</span></td>

                               </tr>
                                                        <tr class="tax">
                                                                <td>Tax</td>
                                <td></td>
                                <td><span id="tax-price">2.00</span></td>
                            </tr>
                        </table>
                        <div class="order_detail_total">
                            <div> Total</div>
                                                        <div class=""> <span class="small">USD</span><span id="final-price">42</span></div>
                        </div>

                        <div class="sep"></div>

                        <a id="AddToCart" href="javascript:;" class="gradient-btn btn-green cart-btn flex-center">
                            <img src="https://www.codingfirst.org/images/icons/cart_white.svg">
                            Add To Cart
                        </a>

                        <input  type="submit" class="gradient-btn btn-blue buy-btn" value="Buy This Course">
                        <input type="hidden" name="act" value="buy_course">
                    </div>
                </div>

            </div>
            <input type="hidden" name="course_plan" id="course_plan" value="0">

            <div class="white-box-shadow ">
                <div class="package-form">
                    <div class="student_range">
                    <input type="range" id="num_range" value="10" min="10" max="400" step="1" class="progress" link-to="text_box_name">
                        <span class="min">10</span>
                        <span class="max">400</span>
                    </div>
                    <input type="number" name="student_nbr" min="10" max="400" id="text_box_name" link-to="num_range">
                </div>
            </div>
        ...
        <div class="right">
            <div class="package-section-title-2 text-center">
              Suggested Courses
            </div>
            <div class="course-package4 height-555">

            
                <a href="https://www.codingfirst.org/Course/10/Advanced-Game-Programming-With-Scratch-Level-III" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/10.png" alt="">
                ...
                <a href="https://www.codingfirst.org/Course/11/Introduction-to-Creative-Computing-P5-js-Level-I" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/11.png" alt="">
                        <div class="label">   <h3>Introduction to Creative Computing: P5.js Level I</h3></div>
                    </div>
                ...
                <a href="https://www.codingfirst.org/Course/12/Game-Programming-in-P5-js-Level-II" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/12.png" alt="">
                        <div class="label">   <h3>Game Programming in P5.js: Level II</h3></div>
                    </div>
                ...
                <a href="https://www.codingfirst.org/Course/13/Introduction-to-Web-Development-with-HTML-and-CSS-Level-I" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/13.png" alt="">
                        <div class="label">   <h3>Introduction to Web Development with HTML and CSS: Level I</h3></div>
                    </div>
...
<script language="javascript">
    ...
    progress.addEventListener('input', function() {
        ...
        const new_val = value / 4;
        // this.style.background = `linear-gradient(to right, #82CFD0 0%, #82CFD0 ${new_val}%, #fff ${new_val}%, white 100%)`
        this.style.background = `linear-gradient(to right, rgba(19,175,240,0.8) 0%, rgba(9,9,121,0.8) ${new_val}%, #eee ${new_val}%, #eee 100%)`
    });

    document.querySelector(".progress").addEventListener("input", (event) => {
        event.target.style.setProperty('--val', event.target.value);
        document.querySelector("#text_box_name").value = event.target.value;
        document.querySelector("#student_number").textContent = event.target.value;
        document.querySelector("#student_number2").textContent = event.target.value;
    });
    ...
    function FooterFunctions(){
        ...
        $('.choose_plan').click(function() {
            ...
            $('.choose_plan').removeClass('selected');
            $(this).addClass('selected');

            var students = $('#text_box_name').val();
            var calc_price_arr = GetPriceFunc(package_id,plan,students);
            var calc_price = JSON.parse(calc_price_arr);


            var subtotal =  parseFloat(calc_price['subtotal']).toFixed(2);
            var tax = parseFloat(calc_price['tax']).toFixed(2);
            var total_price = parseFloat(calc_price['total_price']).toFixed(2);


            $('#course_plan').val(plan);

            $('#subtotal').text(subtotal);
            $('#tax-price').text(tax);
            $('#final-price').text(total_price);

            var rounded_plan_price = parseFloat(plan_price).toFixed(2);

            $('#plan_price').text(rounded_plan_price);
            $('#plan_price_total').text(rounded_plan_price);


        });
        $('#num_range').change(function() {
            var students = $(this).val();


            var seat_price = 2;

            var plan = $('.choose_plan.selected').attr('data-id');
            ...
            var student_total = parseInt(students) * seat_price;
            var student_total_round = parseFloat(student_total).toFixed(2);
            ...
            $('#student_total_price').text(student_total_round);



        });

        $('#text_box_name').keyup(function() {

            var students = $(this).val();
            $('#num_range').val(students);

            var  new_val_stu = students / 4;
            progress.style.background = `linear-gradient(to right, rgba(19,175,240,0.8) 0%, rgba(9,9,121,0.8) ${new_val_stu}%, #eee ${new_val_stu}%, #eee 100%)`;
            ...
            $('#student_number').text(students);
            $('#student_number2').text(students);
        ...
        $('#AddToCart').click(function(){
            ...
            var chosen_plan = $('#course_plan').val();
            var student_nbr =  $('#text_box_name').val();

            if(student_nbr < 10){
               ShowMessage('Error','Student Number should be greater than 10');
               return false;
            }

            if(student_nbr > 400){
                ShowMessage('Error','Student Number should be less than 400');
                return false;
            }
            ...
            $.ajax({
                method: "POST",
                url: 'https://www.codingfirst.org/ajax/add_to_cart.php',
                data: { course: package_id, plan: chosen_plan, student_nbr : student_nbr, type:'new'  },
                success: function(data){
                    console.log(data);
                    $('#TeacherCartNumber').text(data);


                }
            });

            $('#TeacherCartNumber').removeClass('hidden');
