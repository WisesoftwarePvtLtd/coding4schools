...
<div class="course-highlight">
    <div class="course-img">
        <img src="data/course_package/9.png">
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Advanced Programming with Conditionals</div>
                        <div>This course focuses on deepening the understanding of programming by using conditional statements to control the flow of programs, enabling more complex and dynamic game interactions.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Cloning and Multiple Sprites</div>
                        <div>Learn how to use the concept of cloning in Scratch, allowing for the creation of more engaging and challenging games that involve multiple sprites interacting in unique ways.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Precision and Coordination in Movement</div>
                        <div>Advanced blocks, such as the gliding block and coordinate system, are introduced to enable precise control of sprite movement and improve the overall gaming experience.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Enhancing Visual and Interactive Effects</div>
                        <div>Explore the application of graphic effects like color changes, fisheye, and pixelation to enhance the visual appeal of games. Messaging and broadcast blocks are also utilized to coordinate interactions between sprites.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Incorporating Variables and Operators</div>
                        <div>Dive into the use of variables and operators such as greater than, less than, AND, and OR conditions to add depth and complexity to games, making them more dynamic and challenging.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">Catch The Burger</div>
                <div class="featured-project">

                    <picture style='background-image: url("data/uploaded_files/EatTheBurger_id_2560.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Chicken</div>
                <div class="featured-project">

                    <picture style='background-image: url("uploaded_files/Chicken_id_2561.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Feed The Monkey</div>
                <div class="featured-project">

                    <picture style='background-image: url("data/uploaded_files/FeedTheMonkey_id_2562.gif")'></picture>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                    ...
                    <a href="../Course/10/Advanced-Game-Programming-With-Scratch-Level-III" class="course-item">
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="../Course/12/Game-Programming-in-P5-js-Level-II" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="data/course_package/12.png" alt="">
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="../Course/13/Introduction-to-Web-Development-with-HTML-and-CSS-Level-I" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="data/course_package/13.png" alt="">
