...
<link href="https://www.codingfirst.org/css/main.css?1764146532" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764146532" rel="stylesheet" media="all">
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/14.png">
    ...
    <div class="highlight-content">
        ...
        <div class="overview-list">
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">24 hours</span>
            </div>
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">
                    Introduction to Web Development with HTML and CSS: Level I                </span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>JavaScript Basics and Core Concepts</div>
                        <div>Students will start with the essentials, learning about JavaScript's role in web development, working with variables, and understanding basic data types like numbers, strings, and booleans.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Dynamic Content Manipulation</div>
                        <div>This course covers how to use JavaScript to interact with HTML elements, enabling students to create dynamic web content, such as updating text and images in response to user actions.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Building Interactivity with Functions and Events</div>
                        <div>Through learning functions and event handling, students will explore how to make their web pages interactive, including clickable buttons and other user-triggered actions.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Working with Data Structures</div>
                        <div>Students will delve into arrays and objects, fundamental structures for storing and manipulating data, which are essential for building complex applications.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Practical Applications and Hands-On Projects</div>
                        <div>By creating projects like a basic chatbot, students will apply their knowledge to real-world scenarios, solidifying their skills in JavaScript and preparing them for more advanced programming challenges.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">Chat Bot</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/js1_id_2585.gif")'></picture>
            ...
            <div>
                ...
                <div class="featured-project">
                    ...
                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/js2_id_2586.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Table Of Multiplication</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/js3_id_2587.gif")'></picture>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/18/Game-Development-With-JavaScript" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/18.png" alt="">
                    <div class="label">   <h3>Game Development With JavaScript</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/31/Micro-Bit-Programming-in-JS" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/31.png" alt="">
                    <div class="label">   <h3>Micro:Bit Programming in JS</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                            <span>Middle School</span>
