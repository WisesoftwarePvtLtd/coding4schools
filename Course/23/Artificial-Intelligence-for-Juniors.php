...
<link href="https://www.codingfirst.org/css/main.css?1764145117" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764145117" rel="stylesheet" media="all">
...
<div class="cp_background_course">
        ...
        <div class="course-grid">
            <div class="course-info">
                                ...
                                <div class="course-name">Artificial Intelligence for Juniors</div>
                <div class="course-brief">          This beginner-friendly course introduces young learners to the fascinating world of AI through fun, interactive activities. Students will explore AI concepts, engage with AI-powered tools, and develop a solid foundation in programming. Using simple block-based coding and visual tools, they will learn how AI systems recognize patterns, make decisions, and even interact with humans.</div>
                <div class="sep"></div>
                <div class="sep"></div>
                <a target="_blank" href="https://www.codingfirst.org/data/ts_course_syllabus/23.pdf?1764145117" class="button">View Syllabus</a>

                                  <a href="https://www.codingfirst.org/Register" class="button3 ">Join For Free</a>

               
                                    <a href="https://www.codingfirst.org/CoursePlan/23" class="button2 ">Get This course</a>
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/23.png">
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Introduction to Artificial Intelligence (AI) Concepts</div>
                        <div>This course introduces young learners to the basics of AI, exploring what artificial intelligence is and how it is used in everyday life through fun and engaging activities.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Hands-On AI Activities</div>
                        <div>Students will participate in interactive activities with tools like Quick Draw and Auto Draw, allowing them to experience how AI can recognize and interpret drawings, objects, and patterns.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Exploring AI in Programming</div>
                        <div>Through simple coding exercises, students will learn the role of AI in programming and explore how machines can be trained to make decisions and respond to different inputs.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Understanding Image and Emotion Recognition</div>
                        <div>Students will explore basic AI-powered image recognition and emotion detection, experimenting with programs that detect facial expressions and categorize images.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Building Fun Projects</div>
                        <div>The course includes hands-on practice where students will create custom AI models, helping them understand how AI learns from examples to make predictions.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">Eat The Apples</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/aiforjrs_id_2574.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Don't Close Your Eyes</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/dontcloseyoureyes_id_2575.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Pop The Bubbles</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/popthebubbles_id_2576.gif")'></picture>
