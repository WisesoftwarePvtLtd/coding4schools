...
<link href="https://www.codingfirst.org/css/main.css?1764147475" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764147475" rel="stylesheet" media="all">
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/31.png">
    ...
    <div class="highlight-content">
        ...
        <div class="overview-list">
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">38 hours</span>
            </div>
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">
                    Introduction to Micro:Bit                </span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Introduction to Micro:bit and JavaScript Basics</div>
                        <div>This course begins with an introduction to the Micro:bit device and the MakeCode platform, where students will learn the basics of JavaScript programming in a hands-on, interactive way.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Programming with JavaScript Blocks and Text</div>
                        <div>Students will start by creating simple programs with block-based coding and gradually transition to JavaScript text-based coding, building a strong foundation in both programming methods.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Creating Interactive Programs</div>
                        <div>Through various projects, students will learn to display text, numbers, and images on the Micro:bit, experimenting with beginner projects like "Hello, World!" and "Beating Heart."</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Using Sensors and Building Responsive Programs</div>
                        <div>The course explores sensor-based programming with Micro:bit, where students will create fun and interactive projects like sound level detection, timers, and motion-based games.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Building Games and Custom Animations</div>
                        <div>Students will apply their JavaScript skills to create games and animations, such as guessing games, countdowns, and light alarms, enhancing their understanding of programming logic and interactivity.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">If On Edge, Bounce</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/microjs1_id_2615.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Timer</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/microjs2_id_2616.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Shooter Game</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/microjs3_id_2617.gif")'></picture>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/27/Introduction-to-Makey-Makey" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/27.png" alt="">
                    <div class="label">   <h3>Introduction to Makey-Makey</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                            <span>Primary</span>
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/30/Introduction-to-Micro-Bit" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/30.png" alt="">
                    <div class="label">   <h3>Introduction to Micro:Bit</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
