...
<link href="https://www.codingfirst.org/css/main.css?1764153054" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764153054" rel="stylesheet" media="all">
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/26.png">
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Fundamentals of Data Analysis</div>
                        <div>This course introduces students to the basics of data analysis, focusing on how to extract insights from data using Python and the NumPy library.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Working with NumPy for Data Manipulation</div>
                        <div>Students will learn essential data manipulation techniques, including array indexing, slicing, and filtering, building a foundation in handling data efficiently.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Exploring Data Types and Statistical Functions</div>
                        <div>Through hands-on practice, students will work with different data types in NumPy and perform basic statistical analyses, equipping them with key skills for data interpretation.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Practical Applications Through Projects</div>
                        <div>The course includes real-world projects such as Sales Analysis and Student Performance Analysis, allowing students to apply their skills in meaningful contexts.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Handling and Analyzing Complex Data</div>
                        <div>By working with CSV files and using NumPy arrays to store and analyze data, students will gain experience in managing larger datasets, preparing them for advanced analytics work.</div>
                    </div>
