...
<link href="https://www.codingfirst.org/css/main.css?1764153445" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764153445" rel="stylesheet" media="all">
        ...
        <div class="course-grid">
            <div class="course-info">
                        ...
                        <div class="discount">
                                ...
                                <div class="course-name">Game Development With JavaScript</div>
                <div class="course-brief">   In this course, students will explore the basics of game development using HTML, CSS, and JavaScript, the core technologies of the web. 
Students will build a variety of interactive games while learning how to use JavaScript to create animations, handle user inputs, and control game logic. The course also covers essential programming concepts such as loops, functions, and conditional statements, giving students the tools to develop more complex game mechanics.
By the end of this course, students will have built a collection of web-based games and developed a strong foundation in combining HTML, CSS, and JavaScript to create interactive and dynamic gameplay experiences.</div>
                <div class="sep"></div>
                <div class="sep"></div>
                <a target="_blank" href="https://www.codingfirst.org/data/ts_course_syllabus/18.pdf?1764153445" class="button">View Syllabus</a>

                                  <a href="https://www.codingfirst.org/Register" class="button3 ">Join For Free</a>

               
                                    <a href="https://www.codingfirst.org/CoursePlan/18" class="button2 ">Get This course</a>
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/18.png">
        ...
        <div class="overview-list">
            <div class="overview-detail">
                <span class="header">Level</span>
                 <div class="sep2"></div>
                <span class="detail">High School</span>
            </div>

            <div class="overview-detail">
                <span class="header">Grades</span>
                <div class="sep2"></div>
                <span class="detail">grade 10-12</span>
            </div>

            <div class="overview-detail">
                <span class="header">Duration</span>
                <div class="sep2"></div>
                <span class="detail">30 hours</span>
            </div>
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">
                    Web development with JavaScript                </span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Introduction to Web-Based Game Development</div>
                        <div>This course provides an introduction to creating games with JavaScript, CSS, and HTML, covering the basics of web development and laying the groundwork for interactive game design.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Core JavaScript Skills for Game Logic</div>
                        <div>Students will learn essential JavaScript concepts such as variables, functions, and loops, which are fundamental for controlling game mechanics and building interactive elements.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Building Interactive and Responsive Games</div>
                        <div>Through projects, students will practice creating interactive features like click actions, animations, and dynamic responses, enhancing player engagement within their games.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Applying Advanced Game Mechanics</div>
                        <div>The course includes a variety of game types, where students will explore mechanics like timing, scoring, and conditional actions, reinforcing logical thinking and problem-solving.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Project-Based Learning for a Game Portfolio</div>
                        <div>Students will develop a portfolio of simple but engaging games, such as calculators, rock-paper-scissors, and space shooters, demonstrating their skills in JavaScript game development and readying them for more advanced projects.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">Pop The Balloons</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/game1_id_2597.gif		")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Smart Chatbot</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/game2_id_2598.gif")'></picture>
            ...
            <div>
                ...
                <div class="featured-project">
                    ...
                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/game3_id_2599.gif")'></picture>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/14/Web-development-with-JavaScript" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/14.png" alt="">
                    <div class="label">   <h3>Web development with JavaScript</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                            <span>Middle School</span>
