...
<link href="https://www.codingfirst.org/css/main.css?1764147876" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764147876" rel="stylesheet" media="all">
...
<div class="cp_background_course">
        ...
        <div class="course-grid">
            <div class="course-info">
                                ...
                                <div class="course-name">Advanced concepts in Python: Level II</div>
                <div class="course-brief">       In this course, students will further develop their Python skills by exploring advanced concepts and tackling practical projects. Building on the foundations learned in Level I, this course introduces more complex topics such as lists, dictionaries, and advanced looping techniques. Students will work on engaging projects like creating a maze, building a small bank system, and developing a simple chatbot. The course also includes practice lessons that challenge students to apply their knowledge in various scenarios, reinforcing their understanding of core Python concepts. By the end of this course, students will have gained a deeper understanding of Python programming and be equipped to create more sophisticated applications and solutions.</div>
                <div class="sep"></div>
                <div class="sep"></div>
                <a target="_blank" href="https://www.codingfirst.org/data/ts_course_syllabus/16.pdf?1764147876" class="button">View Syllabus</a>

                                  <a href="https://www.codingfirst.org/Register" class="button3 ">Join For Free</a>

               
                                    <a href="https://www.codingfirst.org/CoursePlan/16" class="button2 ">Get This course</a>
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/16.png">
    ...
    <div class="highlight-content">
        ...
        <div class="overview-list">
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">
                    Introduction to Python: Level I                </span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Exploring Complex Data Structures</div>
                        <div>Students will deepen their understanding of Python lists and dictionaries, learning how to store, retrieve, and manipulate data in more advanced ways, which are crucial for building real-world applications.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Advanced Loops and Operators</div>
                        <div>This course covers complex loop structures and operators, empowering students to create efficient, flexible, and powerful code for a wide range of programming challenges.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Problem Solving with Practical Projects</div>
                        <div>Through projects like developing a small banking system and interactive puzzles, students will apply advanced programming concepts in creative and engaging ways, strengthening their problem-solving skills.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Building Interactive Programs</div>
                        <div>Students will explore how to create interactive Python applications, including a simple chatbot and a login system, which introduce key concepts in user interaction and program functionality.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Creating Functional Python Applications</div>
                        <div>Students will build several functional applications, strengthening their skills in using data structures, control flow, and interactive elements, which will prepare them for real-world coding challenges.</div>
                    </div>
    ...
    <div class="row-centered p-40 w100">
        <div class="main-title-black text-center">Featured projects </div>
            ...
            <div>
                          ...
                          <div class="project-title">My Bank</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/py4_id_2603.gif")'></picture>
            ...
            <div>
                          ...
                          <div class="project-title">Binary Search</div>
                <div class="featured-project">

                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/py5_id_2604.gif")'></picture>
            ...
            <div>
                ...
                <div class="featured-project">
                    ...
                    <picture style='background-image: url("https://www.codingfirst.org/data/uploaded_files/py6_id_2605.gif")'></picture>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                    ...
                    <a href="https://www.codingfirst.org/Course/15/Introduction-to-Python-Level-I" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/15.png" alt="">
                    <div class="label">   <h3>Introduction to Python: Level I</h3></div>
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/26/Introduction-to-Data-Analytics" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/26.png" alt="">
                    <div class="label">   <h3>Introduction to Data Analytics</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                            <span>High School</span>
                ...
                <button class="sample-btn">View Course</button>
                    ...
                    <a href="https://www.codingfirst.org/Course/34/Introduction-to-Artificial-Intelligence" class="course-item">
                <div class="circle"></div>
                <div class="course-detail">
                    <img src="https://www.codingfirst.org/data/course_package/34.png" alt="">
                    <div class="label">   <h3>Introduction to Artificial Intelligence</h3></div>
                    <div class="highlights">
                        <div>
                            <span>Level</span>
                            <span>High School</span>
