...
<link href="https://www.codingfirst.org/css/style.css?1764567054" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764567054" rel="stylesheet" media="all">
    ...
    <div class="grid-pattern-7">
        <div class="left">
            ...
            <div class="course-package flex-space-between">
                                ...
                                <img src="https://www.codingfirst.org/images/discount_badge6.png">
                            </div>

                                                <div class="circle"></div>
                        <div class="course-detail">
                            <img src="https://www.codingfirst.org/data/course_package/4.png" alt="">
                            <div class="label">   <h3>Basics of block programming: Scratch Junior Level I</h3></div>
                ...
                <div class="white-box-shadow w-50 m-b-30p">
                    <div class="order-detail">
                        ...
                        <table class="order_detail_price">
                            ...
                            <tr>
                                <td>Package Price</td>
                                <td>1 x <span id="plan_price">15.00</span></td>
                                <td><span id="plan_price_total">15.00</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><span id="student_total_price">20.00</span></td>
                                                       ...
                                                       <tr class="old-subtotal">
                                <td>Subtotal</td>
                                <td></td>
                                <td><span class="old_price" >35.00</span></td>
                            </tr>
                               <tr class="discounted-price">
                                   <td>Discounted Price</td>
                                   <td> <span class="discount"> - 40%</span></td>
                                   <td><span class="new_price">21.00</span></td>
                               </tr>
                                                        <tr class="tax">
                                                                <td>Tax</td>
                                <td></td>
                                <td><span id="tax-price">1.05</span></td>
                            </tr>
                        </table>
                        <div class="order_detail_total">
                            <div> Discounted Total</div>
                                                        <div class="discounted_price"> <span class="small">USD</span><span id="final-price">22.05</span></div>
                        </div>
        ...
        <div class="right">
            ...
            <div class="course-package4 height-555">
                ...
                <a href="https://www.codingfirst.org/Course/6/Game-Development-Basics-Scratch-Junior-Level-II" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/6.png" alt="">
                        <div class="label">   <h3>Game Development Basics: Scratch Junior Level II</h3></div>
                    </div>
                ...
                <a href="https://www.codingfirst.org/Course/8/Basics-Of-Scratch" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/8.png" alt="">
                ...
                <a href="https://www.codingfirst.org/Course/9/Game-development-with-Scratch-Level-I" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
