...
<link href="https://www.codingfirst.org/css/main.css?1764146996" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764146996" rel="stylesheet" media="all">
...
<div class="cp_background_course">
        ...
        <div class="course-grid">
            <div class="course-info">
                                ...
                                <div class="course-name">Introduction to mBot Robotics</div>
                <div class="course-brief">     The mBot Robotics Course introduces young learners to the exciting world of robotics and coding using the mBot—a fun and easy-to-use robot designed for education. Through this course, students will explore the basics of robotics, electronics, and programming as they bring the mBot to life with simple drag-and-drop coding in the mBlock software.
The course covers essential robotics concepts, such as movement, sensors, and automation, while encouraging creativity through hands-on challenges. Students will learn how to program their mBot to perform tasks like obstacle avoidance, line-following, and even light and sound responses. By the end of the course, students will have a strong foundation in robotics and coding, sparking an interest in technology and engineering.</div>
                <div class="sep"></div>
                <div class="sep"></div>
                <a target="_blank" href="https://www.codingfirst.org/data/ts_course_syllabus/24.pdf?1764146996" class="button">View Syllabus</a>

                                  <a href="https://www.codingfirst.org/Register" class="button3 ">Join For Free</a>

               
                                    <a href="https://www.codingfirst.org/CoursePlan/24" class="button2 ">Get This course</a>
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/24.png">
    ...
    <div class="highlight-content">
        ...
        <div class="overview-list">
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">26 hours</span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Getting Started with mBot Robotics</div>
                        <div>This course begins with an introduction to the mBot, teaching students how to assemble, connect, and upload code to their robot, setting the foundation for hands-on robotics learning.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Basic Robot Movements and Controls</div>
                        <div>Students will learn to control the mBot's movements, using remote commands and programming sequences to make the robot move, stop, and follow specific paths.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Sensor-Based Interactions</div>
                        <div>Through activities with line-following and ultrasonic sensors, students will program their mBot to detect obstacles, follow lines, and respond to its environment, enhancing problem-solving and logic skills.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Exploring LED Displays and Messages</div>
                        <div>The course introduces students to the mBot’s LED matrix, teaching them how to display text, images, and patterns, and even broadcast messages for interactive projects.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Building Interactive and Themed Projects</div>
                        <div>Students will apply their skills by creating fun projects like “KungFu Panda” and “mBot Dances in the Dark,” making robotics learning engaging and creative.</div>
                    </div>
