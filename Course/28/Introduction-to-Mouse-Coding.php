...
<link href="https://www.codingfirst.org/css/main.css?1764145263" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764145263" rel="stylesheet" media="all">
...
<div class="cp_background_course">
        ...
        <div class="course-grid">
            <div class="course-info">
                                ...
                                <div class="course-name">Introduction to Mouse Coding</div>
                <div class="course-brief">      The Introduction to Mouse Coding with Code & Go course is designed to introduce young students to the world of coding through engaging, hands-on activities using the Code & Go Mouse. This beginner-friendly course focuses on basic coding principles such as sequencing, loops, and logic, all while promoting problem-solving and critical thinking.
Students will learn to program the mouse to navigate through mazes, reinforcing concepts like directional commands, patterns, and debugging. With a focus on interactive play and exploration, this course makes coding accessible and fun, helping students build a strong foundation for future STEM learning.</div>
                <div class="sep"></div>
                <div class="sep"></div>
                <a target="_blank" href="https://www.codingfirst.org/data/ts_course_syllabus/28.pdf?1764145263" class="button">View Syllabus</a>

                                  <a href="https://www.codingfirst.org/Register" class="button3 ">Join For Free</a>

               
                                    <a href="https://www.codingfirst.org/CoursePlan/28" class="button2 ">Get This course</a>
...
<div class="course-highlight">
    <div class="course-img">
        <img src="https://www.codingfirst.org/data/course_package/28.png">
    ...
    <div class="highlight-content">
        ...
        <div class="overview-list">
            ...
            <div class="overview-detail">
                ...
                <div class="sep2"></div>
                <span class="detail">25 hours</span>
            </div>
        ...
        <div class="course-overview-section">
                ...
                <div class="overview-item" >
                    ...
                    <div class="overview-info">
                        <div>Introduction to Coding Concepts</div>
                        <div>This course begins with an overview of basic coding concepts, introducing students to the fundamentals of programming through hands-on activities with a mouse robot.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>2</span>
                    <div class="overview-info">
                        <div>Learning Mouse Robot Controls</div>
                        <div>Students will learn to operate the mouse robot, exploring how to control its movements, including forward, backward, left, and right turns, laying the groundwork for precision in navigation.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>3</span>
                    <div class="overview-info">
                        <div>Step-by-Step Guided Activities</div>
                        <div>The course includes a series of activity cards that progressively introduce new challenges and mazes, allowing students to practice coding sequences and solve problems with the mouse robot.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>4</span>
                    <div class="overview-info">
                        <div>Developing Sequencing and Problem-Solving Skills</div>
                        <div>Through guided exercises, students will enhance their sequencing and logic skills, programming the mouse robot to complete various tasks and navigate mazes.</div>
                    </div>
                ...
                <div class="overview-item" >
                    <span>5</span>
                    <div class="overview-info">
                        <div>Interactive and Fun Learning Experience</div>
                        <div> With engaging activities, students will gain confidence in programming by controlling the mouse robot, reinforcing foundational coding principles in a fun, hands-on environment.</div>
                    </div>
...
<div class="padding-50" >
    ...
    <div class="course-package">
                    ...
                    <a href="https://www.codingfirst.org/Course/4/Basics-of-block-programming-Scratch-Junior-Level-I" class="course-item">
