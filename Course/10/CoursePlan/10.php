...
<link href="https://www.codingfirst.org/css/style.css?1764673734" rel="stylesheet" media="all">
<link href="https://www.codingfirst.org/css/course_module.css?1764673734" rel="stylesheet" media="all">
    ...
    <div class="grid-pattern-7">
                ...
                <div class="white-box-shadow w-50 m-b-30p">
                    <div class="order-detail">
                        ...
                        <table class="order_detail_price">
                            ...
                            <tr>
                                <td>Package Price</td>
                                <td>1 x <span id="plan_price">25.00</span></td>
                                <td><span id="plan_price_total">25.00</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><span id="student_total_price">20.00</span></td>
                                   ...
                                   <td>Subtotal</td>
                                   <td></td>
                                   <td><span id="subtotal">45.00</span></td>

                               </tr>
                                                        <tr class="tax">
                                                                <td>Tax</td>
                                <td></td>
                                <td><span id="tax-price">2.25</span></td>
                            </tr>
                        </table>
                        <div class="order_detail_total">
                            <div> Total</div>
                                                        <div class=""> <span class="small">USD</span><span id="final-price">47.25</span></div>
                        </div>
        ...
        <div class="right">
            ...
            <div class="course-package4 height-555">
                ...
                <a href="https://www.codingfirst.org/Course/33/Game-development-with-Scratch-Level-II" class="course-item">
                    <div class="circle"></div>
                    <div class="course-detail">
                        <img src="https://www.codingfirst.org/data/course_package/33.png" alt="">
                        <div class="label">   <h3>Game development with Scratch: Level II</h3></div>
                    </div>
