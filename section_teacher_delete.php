...
if ($id == 0) {
    ...
    header("Location: assign-teacher-section.php?section=$section&grade=$grade");
    exit();
}

$sql = "DELETE FROM section_teachers WHERE section_teacher_id = $id";

if ($conn->query($sql)) {
    $_SESSION['msg']  = "Teacher removed successfully!";
     $_SESSION['transaction_status'] = TRANSACTION_STATUS_SUCCESS;
} else {
    $_SESSION['msg']  = "Failed to remove teacher!";
    $_SESSION['transaction_status'] = TRANSACTION_STATUS_ERROR;
}
