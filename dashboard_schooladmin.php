...
<body>
    <div class="container-fluid p-3" style="padding: 30px;">
                        ...
                        <div class="main-content" style="flex: 3;">
                            <div class="row g-4 mb-3">
                                ...
                                $stmt = $conn->prepare("
                                   ...
                                   AND (
        -- CASE 1: DISPATCH quiz (visible to school/users)
        (
            q.status = 'DISPATCH'
            AND (
                q.school_id = 0
        ...
        -- CASE 2: NOT DISPATCH (draft → only creator can see)
        (
            q.status != 'DISPATCH'
            AND q.user_id = ?
        )
                                ...
                                $stmt->bind_param("iiii", $userSchoolId, $user_id, $userSchoolId, $user_id);
                                $stmt->execute();
